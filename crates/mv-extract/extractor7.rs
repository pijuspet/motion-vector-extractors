...
fn main() {
    ...
    unsafe {
        ...
        // Reference frames only: drop non-reference frames at decode time while
        // keeping reference P/B-frames, which carry the motion vectors.
        (*dec_ctx).skip_frame = ff::AVDiscard::AVDISCARD_NONREF;
